    ...
    <header className="fixed top-0 left-0 right-0 h-20 bg-black/80 backdrop-blur-3xl z-[100] border-b border-white/5 px-4 flex items-center justify-between shadow-[0_15px_50px_rgba(0,0,0,0.9)]">
      ...
      <div className="flex items-center gap-2.5">
        ...
        <button 
          ...
          className="w-11 h-11 rounded-2xl bg-white/5 border-2 border-white/20 flex items-center justify-center text-cyan-400 opacity-80 shadow-[0_0_15px_#22d3ee66] hover:opacity-100 hover:shadow-[0_0_35px_#22d3ee] transition-all"
        >
